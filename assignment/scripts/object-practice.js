...
const me = {
  ...
  hasSiblings: true,
  shoeCount: 8,
  favThreeFoods: ['Ethiopian', 'Mediterranean', 'Italian' ],
};
...
me.shoeCount++
console.log( 'just got a new pair of shoes!! Now i have:', me.shoeCount);
...
console.log( 'Just added my favorite color:', me.favoriteColor);
